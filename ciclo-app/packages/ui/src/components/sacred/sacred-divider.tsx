...
export function SacredDivider({
  ...
  if (variant === 'mandala') {
    return (
      ...
      >
        ...
        <svg viewBox="0 0 40 40" className="mx-4 h-8 w-8 text-[#d4a574]/30" fill="none" stroke="currentColor" strokeWidth="0.5">
  ...
  if (variant === 'wave') {
    return (
      <div
        ...
        {...props}
      >
        <svg viewBox="0 0 400 20" className="h-5 w-full text-[#d4a574]/15" preserveAspectRatio="none">
          <path
  ...
  if (variant === 'sacred') {
    return (
      <div
        ...
        {...props}
      >
        <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#d4a574]/15 to-transparent" />
        <div className="mx-4 flex gap-1.5">
          <div className="h-1.5 w-1.5 rounded-full bg-base-forest/30" />
          <div className="h-1.5 w-1.5 rounded-full bg-[#d4a574]/40" />
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="h-px w-full bg-gradient-to-r from-transparent via-[#d4a574]/20 to-transparent" />
    </div>
  )
}
